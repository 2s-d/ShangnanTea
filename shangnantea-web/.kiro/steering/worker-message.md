...
### 负责的后端文件目录
- `src/main/java/com/shangnantea/controller/MessageController.java` - 消息控制器
- `src/main/java/com/shangnantea/service/MessageService.java` - 消息服务接口
- `src/main/java/com/shangnantea/service/impl/MessageServiceImpl.java` - 消息服务实现
- `src/main/java/com/shangnantea/mapper/MessageMapper.java` - 消息数据访问接口
- `src/main/resources/mapper/MessageMapper.xml` - 消息SQL映射文件
- `src/main/java/com/shangnantea/model/dto/message/` - 消息DTO类
- `src/main/java/com/shangnantea/model/vo/message/` - 消息VO类
- `src/main/java/com/shangnantea/model/entity/Message.java` - 消息实体类

### 负责的前端文件目录（如需要）
- `shangnantea-web/src/api/message.js` - 消息API函数
- `shangnantea-web/src/store/modules/message.js` - 消息状态管理
- `shangnantea-web/src/views/message/` - 消息相关页面
- `shangnantea-web/src/components/message/` - 消息相关组件
