...
#### 接口22: followShop - /shop/{shopId}/follow (2个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 4015 | 已关注店铺 | 关注店铺成功 | 显示 |
| 4127 | 操作失败 | 关注店铺失败 | 显示 |

#### 接口23: unfollowShop - /shop/{shopId}/follow (2个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 4016 | 已取消关注 | 取消关注成功 | [静默] |
| 4128 | 操作失败 | 取消关注失败 | 显示 |

#### 接口24: checkFollowStatus - /shop/{shopId}/follow-status (2个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 200 | 操作成功 | 获取关注状态成功 | [静默] |
| 4129 | 加载失败 | 获取关注状态失败 | 显示 |
