...
#### 接口30: uploadCertificationImage - /user/merchant/certification/image (4个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 2020 | 图片上传成功 | 上传商家认证图片成功 | 显示 |
| 2135 | 图片上传失败 | 上传商家认证图片失败 | 显示 |
| 2136 | 不支持的文件类型 | 文件类型错误 | 显示 |
| 2137 | 文件大小超限 | 文件过大 | 显示 |

#### 接口31: updateUser - /user/admin/users/{userId} (3个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 2021 | 用户已更新 | 更新用户成功 | 显示 |
| 2138 | 提交失败 | 更新用户失败 | 显示 |
| 2139 | 您没有权限执行此操作 | 权限不足 | 显示 |

#### 接口32: deleteUser - /user/admin/users/{userId} (3个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 2022 | 用户已删除 | 删除用户成功 | 显示 |
| 2140 | 删除用户失败 | 删除用户失败 | 显示 |
| 2141 | 您没有权限执行此操作 | 权限不足 | 显示 |

#### 接口33: toggleUserStatus - /user/admin/users/{userId}/status (3个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 2023 | 用户状态已修改 | 切换用户状态成功 | 显示 |
| 2142 | 修改用户状态失败 | 切换用户状态失败 | 显示 |
| 2143 | 您没有权限执行此操作 | 权限不足 | 显示 |

#### 接口34: getCertificationList - /user/admin/certifications (3个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 200 | 操作成功 | 获取认证列表成功 | [静默] |
| 2144 | 加载失败 | 获取认证列表失败 | 显示 |
| 2145 | 您没有权限执行此操作 | 权限不足 | 显示 |

#### 接口35: processCertification - /user/admin/certifications/{id} (3个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 2024 | 操作成功 | 审核认证成功 | 显示 |
| 2146 | 操作失败 | 审核认证失败 | 显示 |
| 2147 | 您没有权限执行此操作 | 权限不足 | 显示 |
...
#### 接口24: likePost - /forum/posts/{id}/like (2个状态码)
...
#### 接口25: unlikePost - /forum/posts/{id}/like (2个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 6015 | 已取消点赞 | 取消点赞成功 | [静默] |
| 6126 | 取消点赞失败 | 取消点赞失败 | 显示 |

#### 接口26: favoritePost - /forum/posts/{id}/favorite (2个状态码)
...
#### 接口27: unfavoritePost - /forum/posts/{id}/favorite (2个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 6017 | 已取消收藏 | 取消收藏成功 | [静默] |
| 6128 | 取消收藏失败 | 取消收藏失败 | 显示 |
...
#### 接口31: likeReply - /forum/replies/{id}/like (2个状态码)
...
#### 接口32: unlikeReply - /forum/replies/{id}/like (2个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 6021 | 已取消点赞 | 取消点赞回复成功 | [静默] |
| 6133 | 取消点赞失败 | 取消点赞回复失败 | 显示 |
...
#### 接口1: uploadFile - /upload (4个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 1000 | 上传成功 | 上传文件成功 | 显示 |
| 1100 | 上传失败 | 上传文件失败 | 显示 |
| 1101 | 不支持的文件类型 | 文件类型错误 | 显示 |
| 1102 | 文件大小超限 | 文件过大 | 显示 |

#### 接口2: uploadImage - /upload/image (4个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 1001 | 上传成功 | 上传图片成功 | 显示 |
| 1103 | 上传失败 | 上传图片失败 | 显示 |
| 1104 | 不支持的文件类型 | 文件类型错误 | 显示 |
| 1105 | 文件大小超限 | 文件过大 | 显示 |
