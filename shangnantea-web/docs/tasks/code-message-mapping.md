...
#### 接口37: getTodayWeather - /user/weather/today (2个状态码)
...
#### 接口3: updateCartItem - /order/cart/update (6个状态码)
...
#### 接口22: updateOrderAddress - /order/address (2个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 5017 | 修改订单地址成功 | 修改订单地址成功 | 显示 |
| 5147 | 修改订单地址失败 | 修改订单地址失败 | 显示 |
...
#### 接口38: uploadArticleImage - /forum/articles/image (4个状态码)

| Code | 消息 | 场景 | 显示 |
|------|------|------|------|
| 6029 | 图片上传成功 | 上传文章图片成功 | 显示 |
| 6143 | 图片上传失败 | 上传文章图片失败 | 显示 |
| 6144 | 不支持的文件类型 | 文件类型错误 | 显示 |
| 6145 | 文件大小超限 | 文件过大 | 显示 |
...
| 7006 | 操作成功 | 创建会话成功 | 显示 |
| 7113 | 操作失败 | 创建会话失败 | 显示 |
| 71131 | 操作失败 | 店主不能给自己的店铺发起客服会话 | 显示 |
...
| 9 | payOrder | POST | /order/pay | 5006, 5007 | 5117, 5118, 5119 | 支付订单 |
...
| 38 | uploadArticleImage | POST | /forum/articles/image | 6029 | 6143, 6144, 6145 | 上传文章图片 |

### 5.5 分类管理 (4个)

| 序号 | 接口函数 | 请求方式 | 路径 | 成功码 | 失败码 | 备注 |
|------|----------|----------|------|--------|--------|------|
| 39 | getCategories | GET | /forum/categories | 200 | 6100 | 获取分类列表 |
| 40 | createCategory | POST | /forum/categories | 6030 | 6146 | 创建分类 |
| 41 | updateCategory | PUT | /forum/categories/{id} | 6031 | 6147 | 更新分类 |
| 42 | deleteCategory | DELETE | /forum/categories/{id} | 6032 | 6148 | 删除分类 |
