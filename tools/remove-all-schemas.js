/**
 * 移除所有响应中的 schema 定义，只保留 example
 * 参考旧版本：只有 example，没有 schema
 */

const fs = require('fs')
const path = require('path')

function removeAllSchemas(filePath) {
...
console.log('移除所有响应中的 schema 定义...')
const fixedContent = removeAllSchemas(openapiPath)
...
console.log('✅ 已移除所有 schema，只保留 example（参考旧版本）')
